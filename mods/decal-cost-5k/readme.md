# Decals Cost 5,000 KC

The Mushroom Club's 50,000 KC decals drop to **5,000 KC**.

## What it changes

`master_skill.buy_money`, from 50,000 to 5,000, on the **34** skills priced
...
`snapshots/decal-cost-5k.json` first, so unticking it and saving puts the original
numbers back.
