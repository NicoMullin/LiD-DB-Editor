# Decals Cost 25,000 KC

The Mushroom Club's 50,000 KC decals drop to **25,000 KC**.

## What it changes

`master_skill.buy_money`, from 50,000 to 25,000, on the **34** skills priced
...
`snapshots/decal-cost-25k.json` first, so unticking it and saving puts the original
numbers back.
